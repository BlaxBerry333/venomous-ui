...
export type NodeDataFormValuePanelProps = Partial<
  Omit<WorkflowToolbarPanelProps, 'children'> & {
...
export type WorkflowWorkflowToolbarPanelComponentType =
  NamedExoticComponent<WorkflowToolbarPanelProps>;
