...
export const TRANSITIONS: ITransitions = {
  fast: `all 100ms ${TRANSITION_EASING}`,
  normal: `all 200ms ${TRANSITION_EASING}`,
  slow: `all 300ms ${TRANSITION_EASING}`,
  colors: `background-color 150ms ${TRANSITION_EASING}, border-color 150ms ${TRANSITION_EASING}, color 150ms ${TRANSITION_EASING}`,
  colorsAndShadow: `background-color 150ms ${TRANSITION_EASING}, border-color 150ms ${TRANSITION_EASING}, color 150ms ${TRANSITION_EASING}, box-shadow 150ms ${TRANSITION_EASING}`,
  transform: `transform 150ms ${TRANSITION_EASING}`,
  transformFast: `transform 100ms ${TRANSITION_EASING}`,
  opacity: `opacity 150ms ${TRANSITION_EASING}`,
  progress: `300ms ${TRANSITION_EASING}`,
};
