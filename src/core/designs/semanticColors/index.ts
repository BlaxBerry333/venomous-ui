...
export const SEMANTIC_COLORS: ISemanticColors = {
  /**
   * Success - Green tones for positive actions, confirmations, completions
   */
  success: {
    light: "#81C784", // Green 300 - backgrounds, hover
    main: "#4CAF50", // Green 500 - primary
    dark: "#388E3C", // Green 700 - borders, active
  },
  /**
   ...
   */
  info: {
    light: "#4DD0E1", // Cyan 300
    main: "#00BCD4", // Cyan 500
    dark: "#0097A7", // Cyan 700
  },
};

export type ISemanticColors = Record<
  "success" | "error" | "warning" | "info",
  Pick<IColorsGroup, "main" | "light" | "dark">
>;
