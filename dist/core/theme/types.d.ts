import type { IBackgroundColors, IBorderColors, IBorderRadius, IBoxShadows, IBreakpoints, IFontColors, IFontSizes, IFontWeights, ILineHeights, IOpacities, IPaletteColors, ISemanticColors, ISpacings, IStrokeWidths, ITransitions, IZIndexs } from "../designs";
/**
 * Theme mode
 */
