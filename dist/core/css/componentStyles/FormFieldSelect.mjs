...
.${N.className} {
  ...
  cursor: pointer;
  color: ${e((a) => a.text.primary)};
  transition: ${s.transitions.colors};
  overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
}
...
.${i.className}:not(.${t.className}):not(.${n.className}):hover .${r.className} {
...
.${b.className}:not(.${t.className}):not(.${n.className}):not(.${i.className}):hover .${r.className} {
...
.${b.className}.${i.className}:not(.${t.className}):not(.${n.className}):hover .${r.className} {
  border-color: ${e((a) => a.semantic.error.dark)};
...
.${c.className}:not(.${t.className}):not(.${n.className}):not(.${i.className}):hover .${r.className} {
  background-color: ${e((a) => a.bg.active)};
}

.${c.className}.${n.className}:not(.${i.className}) .${r.className} {
  background-color: transparent;
  border-color: ${e((a) => a.palette.main)};
}

.${c.className}.${i.className} .${r.className} {
  background-color: color-mix(in srgb, ${e((a) => a.semantic.error.main)} 8%, transparent);
  border-color: transparent;
}

.${c.className}.${i.className}:not(.${t.className}):not(.${n.className}):hover .${r.className} {
  background-color: color-mix(in srgb, ${e((a) => a.semantic.error.main)} 12%, transparent);
}

.${c.className}.${i.className}.${n.className} .${r.className} {
  background-color: transparent;
  border-color: ${e((a) => a.semantic.error.main)};
}
  `.trim();
