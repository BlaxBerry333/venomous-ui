...
const a = {
  ...
  itemDepth1: {
    className: `${e.List}__item--depth-1`,
    description: "List item depth level 1"
  },
  itemDepth2: {
    className: `${e.List}__item--depth-2`,
    description: "List item depth level 2"
  },
  itemDepth3: {
    className: `${e.List}__item--depth-3`,
    description: "List item depth level 3"
  },
  itemDepth4: {
    className: `${e.List}__item--depth-4`,
    description: "List item depth level 4"
  },
  // List.Collapse
  collapse: {
    className: `${e.List}__collapse`,
    description: "List collapse container"
  },
  collapseOpen: {
    className: `${e.List}__collapse--open`,
    description: "List collapse open state"
  },
  collapseContent: {
    className: `${e.List}__collapse-content`,
...
export {
  ...
  T as FORM_FIELD_PASSWORD_CSS_CLASS_NAMES,
  P as FORM_FIELD_RADIO_CSS_CLASS_NAMES,
  z as FORM_FIELD_SELECT_CSS_CLASS_NAMES,
  L as FORM_FIELD_SWITCH_CSS_CLASS_NAMES,
  v as FORM_FIELD_TEXTAREA_CSS_CLASS_NAMES,
  h as FORM_FIELD_TEXT_CSS_CLASS_NAMES,
  f as FORM_LABEL_CSS_CLASS_NAMES,
  n as ICON_CSS_CLASS_NAMES,
  R as LIST_CSS_CLASS_NAMES,
  p as MODAL_CSS_CLASS_NAMES,
  _ as POPOVER_CSS_CLASS_NAMES,
  A as PROGRESS_BAR_CSS_CLASS_NAMES,
  ...
  S as TYPOGRAPHY_TEXT_CSS_CLASS_NAMES,
  $ as TYPOGRAPHY_TITLE_CSS_CLASS_NAMES
};
