 ...
 * Node
 */
export type WorkflowNode<NodeFormValue extends WorkflowNodeFormValue = WorkflowNodeFormValue, NodeType extends string = string> = XYFlowNode<WorkflowNodeData<NodeFormValue>, NodeType>;
/**
 * Node Data
 */
