...
export type WorkflowGroupNodeProps = Omit<WorkflowBaseNodeProps, 'hideSourceHandler' | 'hideTargetHandler'>;
export type WorkflowStartWithContextNodeProps = Omit<WorkflowBaseNodeProps, 'hideSourceHandler' | 'hideTargetHandler'> & {
    onlyOne?: boolean;
};
...
export type WorkflowStartWithContextNodeComponentType = NamedExoticComponent<WorkflowStartWithContextNodeProps>;
