...
export type WorkflowSourceNodeHandlerComponentType = NamedExoticComponent<Omit<WorkflowBaseNodeHandlerProps, 'handlerType'>>;
export type WorkflowTargetNodeHandlerComponentType = NamedExoticComponent<Omit<WorkflowBaseNodeHandlerProps, 'handlerType'>>;
