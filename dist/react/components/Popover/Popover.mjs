...
import T from "../../hooks/useFocusTrap.mjs";
...
const B = e.memo(
  ({ trigger: R, placement: d = "bottom", offset: p = 8, onOpen: l, onClose: m, className: C, style: k, children: x }) => {
    const L = z();
    q(y.Popover, L);
    const g = e.useId(), v = j(k), [t, h] = e.useState(!1), [s, E] = e.useState(null), [, N] = e.useState(d), b = e.useMemo(
      ...
      [s, v]
    ), u = e.useRef(null), o = e.useRef(null);
    T(o, t);
    ...
    const a = e.useCallback(() => {
      ...
      const r = _(u.current), n = o.current.getBoundingClientRect();
    ...
    return e.useEffect(() => {
      ...
      const r = (n) => {
        const i = n.target;
        u.current && !u.current.contains(i) && o.current && !o.current.contains(i) && c();
      };
